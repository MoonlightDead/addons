...
(function () {
    if (window.__interfacelampac_ribbon_patch__) return;
    window.__interfacelampac_ribbon_patch__ = true;
    ...
    default: 0
        ...
        onChange: applyRibbonHeight
    });

    function applyRibbonHeight() {
        var value = Number(
            Lampa.Storage.field('interfacelampac_ribbon_height') || 0
        );

        var id = 'interfacelampac-ribbon-height-style';
